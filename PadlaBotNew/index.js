...
const button_confirm = require("./promoPadla/button_confirm");
const button_avatar = require("./promoPadla/button_avatar");
const button_link = require("./promoPadla/button_link");
const button_avatarAndLink = require("./promoPadla/button_avatarAndLink");
const button_reload= require("./promoPadla/button_reload");
const promo__init = require("./promoPadla/index");
const updateAllUserData = require("./promoPadla/updateAllUserData");
...
(async () => {
    ...
    await button_confirm();
    await button_avatar();
    await button_link();
    await button_avatarAndLink();
    await button_reload();

    //await updateAllUserData("⚠️ Чтобы бот обновился до последней версии, необходимо написать <code>/start</code>");
    //await promo__init();
    setInterval(promo__init,1000*60*60*56)
