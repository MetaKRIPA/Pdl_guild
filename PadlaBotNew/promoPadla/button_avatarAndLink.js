...
module.exports = async function(){
    bot.action(/promo_buttonAvatarAndLink__.+/, async (ctx) => {
        try {
            await promoPadla();
       ...
       Сообщение для выбранного участника.

☝️удача любит тех, кто в нее верит.

Только что ты упустил(а) свой шанс залутать халявные тончики, просто за то что ты ПАДЛА 👹

❗️Больше не упускай такую возможность

Для участия в PADLA PROMO достаточно выполнить два условия:
❌ Поставить Падлу на Аву
❌ Иметь в био ссылку на чат или канал Падл.
         */
    });
}