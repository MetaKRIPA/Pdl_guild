        ...
        try {
            ...
            if(nftUser.length !== 0){
                ...
                await User.updateOne({telegram: dbData.telegram}, {nfts: nftUser, statusNFT: true}).then(() => {
                 ...
                 await ctx.reply("🫥 К сожалению, на вашем кошельке не найдено ни одной <b><a href='https://getgems.io/collection/padla-bear'>PADLA NFT</a></b>",
                    {
                        parse_mode: 'Html',
                        ...Markup.keyboard([
